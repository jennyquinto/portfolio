...
document.addEventListener("click", ({ target }) => {
    ...
    if (target.classList.contains("1")) {
        window.location.assign("https://jennyvanessaquinto.github.io/Sprint1/");       
    }
    if (target.classList.contains("2")) {
        window.location.assign("https://jennyvanessaquinto.github.io/Sprint2/");      
    }
    if (target.classList.contains("3")) {
        window.location.assign("https://jennyvanessaquinto.github.io/ProyectoNivelatorio/");       
    }
});